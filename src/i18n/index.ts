...
const DICTS: Record<Locale, Translations> = { en, zh };
 ...
 * resolving once at module load is enough — no reactivity needed. Any Chinese
 * variant maps to zh; everything else falls back to English.
 */
