/*
 * PluginSettingTab.display() and ButtonComponent.setWarning() are marked
 * "deprecated since 1.13.0" in favour of getSettingDefinitions()/setDestructive(),
 * but those need minAppVersion 1.13.0. Our floor is 1.8.7, so the classic (still
 * fully functional) API is the correct choice here.
 */
